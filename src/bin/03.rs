...
mod tests {
    ...
    fn test_largest_joltage_of_bank() {
        ...
        assert_eq!(
            largest_joltage_of_bank("987654321111111", 12),
            Some(987654321111)
        );
        assert_eq!(
            largest_joltage_of_bank("811111111111119", 12),
            Some(811111111119)
        );
        assert_eq!(
            largest_joltage_of_bank("234234234234278", 12),
            Some(434234234278)
        );
        assert_eq!(
            largest_joltage_of_bank("818181911112111", 12),
            Some(888911112111)
        );
    }
}
